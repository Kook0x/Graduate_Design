...
char	*VidWindow::say()
{
	...
	sprintf_s(line, "Rect x = (%d - %d), y = (%d - %d)", 
			xFrom, xTo, yFrom, yTo);
...
char	*YUVRange::say()
{
	...
	sprintf_s(line, "YUVRange %2x-%2x, %2x-%2x, %2x-%2x", 
...
/****************************************************************/
/* Some commands respond with a line starting with # and ending	with a '\n' */
/* 						*/
